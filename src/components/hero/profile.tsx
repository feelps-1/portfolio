...
export function Profile({ contacts }: ProfileProps) {
    return (
        <div className="md:w-1/3 h-full p-4 flex flex-col md:rounded-md items-start gap-4 text-white bg-slate-800">
            ...
            <section className="rounded rounded-bl-none rounded-tl-none border-l-4 border-l-sky-500 p-4 bg-gray-700 text-white lg:text-sm">
                <span>Me divirto muito programando, vejo como uma ferramenta que permite tornar realidade soluções que mudem a vida das pessoas. Adoro participar de competições, especialmente as de inovação.</span>
            </section>
